...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:AdministrableProductDefinition">
      ...
      <sch:assert test="count(f:formOf) &lt;= 1">formOf: maximum cardinality of 'formOf' is 1</sch:assert>
      <sch:assert test="count(f:producedFrom) &lt;= 1">producedFrom: maximum cardinality of 'producedFrom' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
