...
| :--- | :--- |
| - | **Reference** |
| * | [HealthcareService: identifier = http://example.org/lkf-system/funktionscode#11211100; category = Hospital; type = Hospital Services](HealthcareService-AbteilungKHRied1.md) |
