...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'https://elga.moped.at/StructureDefinition/moped-ext-Leistungsanzahl']) &gt;= 1">extension with URL = 'https://elga.moped.at/StructureDefinition/moped-ext-Leistungsanzahl': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://elga.moped.at/StructureDefinition/moped-ext-Leistungsanzahl']) &lt;= 1">extension with URL = 'https://elga.moped.at/StructureDefinition/moped-ext-Leistungsanzahl': maximum cardinality of 'extension' is 1</sch:assert>
