...
| Draft as of 2026-04-07 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:HTTPVerbInsertUpdateVS |
...
```json
{
  ...
  "id" : "HTTPVerbInsertUpdateVS",
  "url" : "https://elga.moped.at/ValueSet/HTTPVerbInsertUpdateVS",
  "version" : "0.1.0",
