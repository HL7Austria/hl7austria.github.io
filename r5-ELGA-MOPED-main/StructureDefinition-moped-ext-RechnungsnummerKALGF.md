...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/StructureDefinition/moped-ext-RechnungsnummerKALGF | *Version*:0.1.0 | |
| Draft as of 2026-05-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:RechnungsnummerKALGF |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/elga.moped|current/StructureDefinition/moped-ext-RechnungsnummerKALGF)
...
Other representations of profile: [CSV](StructureDefinition-moped-ext-RechnungsnummerKALGF.csv), [Excel](StructureDefinition-moped-ext-RechnungsnummerKALGF.xlsx), [Schematron](StructureDefinition-moped-ext-RechnungsnummerKALGF.sch) 
...
```json
{
  ...
  "url" : "https://elga.moped.at/StructureDefinition/moped-ext-RechnungsnummerKALGF",
  "version" : "0.1.0",
  "name" : "RechnungsnummerKALGF",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://elga.moped.at/StructureDefinition/moped-ext-RechnungsnummerKALGF"
    },
    {
