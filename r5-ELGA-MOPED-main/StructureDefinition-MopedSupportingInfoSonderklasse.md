# ELGA.MOPED\Supporting Info Extension for ClaimResponse - Sonderklasse Slice - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Supporting Info Extension for ClaimResponse - Sonderklasse Slice**

## Extension: Supporting Info Extension for ClaimResponse - Sonderklasse Slice 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/StructureDefinition/MopedSupportingInfoSonderklasse | *Version*:0.1.0 | |
| Draft as of 2026-03-12 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedSupportingInfoSonderklasse |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/elga.moped|current/StructureDefinition/MopedSupportingInfoSonderklasse)
...
Other representations of profile: [CSV](StructureDefinition-MopedSupportingInfoSonderklasse.csv), [Excel](StructureDefinition-MopedSupportingInfoSonderklasse.xlsx), [Schematron](StructureDefinition-MopedSupportingInfoSonderklasse.sch) 
...
```json
{
  ...
  "id" : "MopedSupportingInfoSonderklasse",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "MopedSupportingInfoSonderklasse",
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "Supporting Info Extension for ClaimResponse - Sonderklasse Slice",
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://elga.moped.at/StructureDefinition/MopedSupportingInfoSonderklasse"
    },
    {
