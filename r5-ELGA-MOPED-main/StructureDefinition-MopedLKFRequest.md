...
| Draft as of 2026-05-22 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedLKFRequest |
...
* Use this Profile: [MOPED Abrechnen Bundle KA](StructureDefinition-MopedAbrechnenBundleKA.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://elga.moped.at/StructureDefinition/MopedTransferEncounter"]
      }]
    },
    {
