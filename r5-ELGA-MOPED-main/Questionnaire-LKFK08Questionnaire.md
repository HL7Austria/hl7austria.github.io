# ELGA.MOPED\LKF K08 Questionnaire - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **LKF K08 Questionnaire**

## Questionnaire: LKF K08 Questionnaire 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/Questionnaire/LKFK08Questionnaire | *Version*:0.1.0 | |
| Active as of 2026-05-05 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*: |

 
LKF K08 Questionnaire - Kostenstellen-Statistik und Kostennachweis (Bettenführende Hauptkostenstelle) 
...
```json
{
  ...
  "id" : "LKFK08Questionnaire",
  "url" : "https://elga.moped.at/Questionnaire/LKFK08Questionnaire",
  "version" : "0.1.0",
  ...
  {
    "linkId" : "bettenführende-hauptkostenstelle-funktionscode",
    "text" : "Bettenführende Hauptkostenstelle – Funktionscode",
    "type" : "integer",
    "maxLength" : 8
  },
  {
    "linkId" : "systemisierte-betten",
    "text" : "Systemisierte Betten",
    "type" : "integer",
    "maxLength" : 6
  },
  {
    "linkId" : "tatsächlich-aufgestellte-betten",
