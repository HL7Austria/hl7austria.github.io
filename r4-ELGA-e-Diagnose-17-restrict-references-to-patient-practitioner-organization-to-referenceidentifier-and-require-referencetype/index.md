...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-at-elga-ediag-practitionerrole.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/at-elga-ediag-practitionerrole"
      },
      "name" : "AT ELGA e-Diagnose PractitionerRole",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-at-elga-ediag-relatedperson.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/at-elga-ediag-relatedperson"
      },
      "name" : "AT ELGA e-Diagnose RelatedPerson",
