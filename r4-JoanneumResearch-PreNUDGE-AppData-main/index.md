...
* **Self-reported emotional burden** (PHQ-2; „Whooley Questions”) (from a [**questionnaire**](Questionnaire-WhooleyQuestionnaire.md), result mapped to an [**observation**](StructureDefinition-at-prenudge-whooley-observation.md))
* **Self-reported stress** (PSS-4 / PSS-10) - perceived stress over the past month/four weeks 
* PSS-4 (4-item) - from a [**questionnaire**](Questionnaire-Pss4Questionnaire.md) with calculated score as an [**observation**](StructureDefinition-at-prenudge-pss4-score-observation.md)
...
Additional PreNUDGE measurements, also narrow standardized, will be specified analogously to the ones mentioned above in the future.
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE ATHIS Answer Options",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE Observation PSS-10 Score",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE Observation PSS-4 Score",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE Observation Whooley Depression Screening",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE PSS Frequency Answer Scale",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE PSS Instrument Codes",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE ValueSet PSS Frequency Answer Scale",
    ...
    },
    {
      ...
      "name" : "AT PreNUDGE ValueSet Whooley Screen Result",
    ...
    },
    {
      ...
      "name" : "PSS-10 Score O mapped from Q - Example",
      "description" : "Example of a PSS-10 score Observation derived from pss10-response-example. Total score = 19.",
      "exampleCanonical" : "https://fhir.hl7.at/prenudge/appdata/r4/StructureDefinition/at-prenudge-pss10-score-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "name" : "PSS-4 Score O mapped from Q - Example",
      "description" : "Example of a PSS-4 score Observation derived from pss4-response-example. Total score = 8.",
      "exampleCanonical" : "https://fhir.hl7.at/prenudge/appdata/r4/StructureDefinition/at-prenudge-pss4-score-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "name" : "Whooley O mapped from Q - Example",
      ...
      "exampleCanonical" : "https://fhir.hl7.at/prenudge/appdata/r4/StructureDefinition/at-prenudge-whooley-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Whooley Q - Negative Screen Example (q1 Ja, q2 Nein)",
    ...
    },
    {
      ...
      "name" : "Whooley Q - Positive Screen Example (both Ja)",
    ...
    },
    {
      ...
      "name" : "PSS-10 Q score to O score",
