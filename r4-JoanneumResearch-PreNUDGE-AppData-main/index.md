...
This IG will show how to use the PreNUDGE FHIR API to deliver health indicators as an application provider.

We will focus on fully specifying four PreNUDGE measurements:

* Daily activity as Steps (per day, coming from a questionnaire)
* Daily activity as Steps (per day, coming from a wearable device)
* Alcohol Amount consumed as Number of drinks (per day/week)
* Quality of life (score)

Additional PreNUDGE measurements can be specified and will be listed here.
