# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\Sleep Duration O - Normal Automated Example - FHIR® v4.0.1
...
**issued**: 2026-03-10 07:00:00+0000

**value**: 7.5 h (Details: UCUM codeh = 'h')

**note**: 

> 

Automatisch von Wearable gemessen.
...
```json
{
  ...
  "note" : [{
    "text" : "Automatisch von Wearable gemessen."
  }],
  "method" : {
    "coding" : [{
