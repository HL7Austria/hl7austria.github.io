# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\Nutrition Vegetable Portions O mapped from Q - High Intake Example - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Nutrition Vegetable Portions O mapped from Q - High Intake Example**

## Example Observation: Nutrition Vegetable Portions O mapped from Q - High Intake Example
...
**identifier**: `https://www.joanneum.at`/obs-nut-vp-2026-06-02-001
...
**value**: 4 Portionen (Details: UCUM code{serving} = '{serving}')

**note**: 

> 

Selbstberichtet: hoher Gemüsekonsum, 4 Portionen täglich.
...
```json
{
  ...
  "id" : "nutrition-vegetableportions-high-example",
  "meta" : {
  ...
  "note" : [{
    "text" : "Selbstberichtet: hoher Gemüsekonsum, 4 Portionen täglich."
  }],
  "method" : {
    "coding" : [{
