...
| Active as of 2026-08-18 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:NutritionSugarSaltyFrequencyQuestionnaireResponseToObservation |
  ...
  "group" : [{
    ...
    },
    {
      ...
      "target" : [{
        ...
        {
          "valueString" : "Dietary intake (observable entity)"
        }]
      }]
    },
    {
    ...
    "rule" : [{
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "element" : "valueCoding",
          "variable" : "coding",
          "condition" : "(coding.code != 'meta-unknown') and (coding.code != 'meta-not-stated')"
        }],
        "target" : [{
          "context" : "tgt",
          "contextType" : "variable",
