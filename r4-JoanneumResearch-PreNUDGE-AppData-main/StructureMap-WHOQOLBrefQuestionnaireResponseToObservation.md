...
| Active as of 2026-08-05 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:WHOQOLBrefQuestionnaireResponseToObservation |
...
```json
{
  ...
  "group" : [{
    ...
    },
    {
      ...
      "documentation" : "EffectiveDateTime from authored"
    },
    {
      "name" : "ProcessGeneral",
      "source" : [{
