...
| Active as of 2026-08-18 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:MuscleStrengtheningQuestionnaireResponseToObservation |
...
```json
{
  ...
  "group" : [{
    ...
    },
    {
      ...
      "documentation" : "effectiveDateTime from authored as quantity questionnaire has no embedded date item"
    },
    {
      "name" : "ProcessItem",
      "source" : [{
  ...
  },
  {
    ...
    "rule" : [{
      ...
      "rule" : [{
        ...
        "documentation" : "Map quantity answer directly to Observation.value"
      }]
    }]
  },
  {
