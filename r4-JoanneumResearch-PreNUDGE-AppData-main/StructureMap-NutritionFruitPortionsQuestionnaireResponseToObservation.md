...
| Active as of 2026-08-26 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:NutritionFruitPortionsQuestionnaireResponseToObservation |
  ...
  "group" : [{
    ...
    },
    {
      ...
      "target" : [{
        ...
        {
          "valueString" : "Fruit servings 24 hour Estimated"
        }]
      }]
    },
    {
      "name" : "ProcessDH1Absence",
      "source" : [{
        "context" : "src",
        "element" : "item",
        "variable" : "item",
        "condition" : "linkId = 'DH1'"
      }],
      "dependent" : [{
        "name" : "MapFruitFrequencyAbsence",
        "variable" : ["item", "tgt"]
      }]
    },
    {
