# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\Alcohol Use O - Moderate (3-4 times weekly) - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Alcohol Use O - Moderate (3-4 times weekly)**

## Example Observation: Alcohol Use O - Moderate (3-4 times weekly)

Profile: [AT PreNUDGE Observation Alcohol Use](StructureDefinition-at-prenudge-alcoholuse-observation.md)

**identifier**: `https://www.joanneum.at`/obs-alc-2026-03-03-001
...
```json
{
  ...
  "id" : "alcoholuse-moderate-example",
  "meta" : {
