# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\Smoking Status O - Not Stated Example - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Smoking Status O - Not Stated Example**

## Example Observation: Smoking Status O - Not Stated Example

Profile: [AT PreNUDGE Observation Smoking Status](StructureDefinition-at-prenudge-smokingstatus-observation.md)

**identifier**: `https://www.joanneum.at`/obs-smokingstatus-2026-03-13-not-stated
...
**issued**: 2026-03-13 00:00:00+0000

**dataAbsentReason**: Asked But Declined

**method**: Manual

**derivedFrom**: [Response to Questionnaire '->Rauchstatus und Nikotinkonsum' about '->James Pond Male, DoB: 1990-01-01 ( urn:oid:1.2.40.0.10.1.4.3.1#1234567890)'](QuestionnaireResponse-SmokingStatusResponseNotStated.md)
...
```json
{
  ...
  "id" : "smokingstatus-not-stated-example",
  "meta" : {
