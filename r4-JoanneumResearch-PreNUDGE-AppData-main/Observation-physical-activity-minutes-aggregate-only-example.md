# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\Physical Activity Minutes O - (a) Aggregate Only (Manual) - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Physical Activity Minutes O - (a) Aggregate Only (Manual)**

## Example Observation: Physical Activity Minutes O - (a) Aggregate Only (Manual)
...
**identifier**: `https://www.joanneum.at`/obs-pa-a-2026-03-24-001
...
| :--- | :--- | :--- |
| - | **Code** | **Value[x]** |
| * | Duration of physical activity | 200 min/wk (Details: UCUM codemin/wk = 'min/wk') |
...
```json
{
  ...
  "id" : "physical-activity-minutes-aggregate-only-example",
  "meta" : {
