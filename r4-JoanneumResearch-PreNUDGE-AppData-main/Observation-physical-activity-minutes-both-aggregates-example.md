# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\Physical Activity Minutes O - (g) Both Aggregates (Automated, MET-Cal) - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Physical Activity Minutes O - (g) Both Aggregates (Automated, MET-Cal)**

## Example Observation: Physical Activity Minutes O - (g) Both Aggregates (Automated, MET-Cal)
...
**identifier**: `https://www.joanneum.at`/obs-pa-g-2026-03-24-001
...
> **component****code**: Duration of physical activity**value**: 180 min/wk (Details: UCUM codemin/wk = 'min/wk')
...
```json
{
  ...
  "id" : "physical-activity-minutes-both-aggregates-example",
  "meta" : {
