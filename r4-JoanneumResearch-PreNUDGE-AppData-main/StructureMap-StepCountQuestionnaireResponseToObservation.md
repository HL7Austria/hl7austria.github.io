...
| Active as of 2026-08-18 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:StepCountQuestionnaireResponseToObservation |
...
```json
{
  ...
  "group" : [{
    ...
    },
    {
      ...
      "documentation" : "Quantity step count entry"
    }]
  },
  {
    "name" : "MapStepCount",
    ...
    "rule" : [{
      ...
      "rule" : [{
        ...
        "documentation" : "effectiveDateTime from nested item with linkId = 'date'"
      },
      {
