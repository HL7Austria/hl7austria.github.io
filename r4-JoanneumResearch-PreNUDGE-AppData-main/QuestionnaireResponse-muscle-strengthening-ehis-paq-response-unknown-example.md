# HL7.AT.FHIR.PRENUDGE.APPDATA.R4\EHIS-PAQ Q8 / ATHIS PE8 Muscle Strengthening Q - Unknown Example - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EHIS-PAQ Q8 / ATHIS PE8 Muscle Strengthening Q - Unknown Example**

## Example QuestionnaireResponse: EHIS-PAQ Q8 / ATHIS PE8 Muscle Strengthening Q - Unknown Example

Profile: [AT PreNUDGE Questionnaire Response](StructureDefinition-at-prenudge-questionnaireresponse.md)

* [LinkID](https://hl7.org/fhir/R4/formats.html#table): muscle-strengthening-ehis-paq-response-unknown-example
...
```json
{
  ...
  "id" : "muscle-strengthening-ehis-paq-response-unknown-example",
  "meta" : {
