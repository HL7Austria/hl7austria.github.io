# HL7.AT.FHIR.CORE.R5\Administrative Gender Addition - FHIR® v5.0.0
...
| Active as of 2025-11-27 | *Responsible:*[HL7® Austria, TC FHIR®](https://hl7.at/technische-komitees/tc-fhir/) | *Computable Name*:AdministrativeGenderAddition |
...
```json
{
  ...
  "context" : [
    ...
    {
      "type" : "element",
      "expression" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-patient#Patient.gender"
    },
    {
      "type" : "element",
      "expression" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-patient#Patient.contact.gender"
    },
    {
      "type" : "element",
      "expression" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-practitioner#Practitioner.gender"
    }
  ],
  "type" : "Extension",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-ext-gender-administrativeGenderAddition"
      },
      {
        ...
        "constraint" : [
          {
            ...
            "source" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-ext-gender-administrativeGenderAddition"
          }
        ],
        "binding" : {
          "strength" : "required",
