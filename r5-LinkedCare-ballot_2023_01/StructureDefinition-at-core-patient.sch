...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.at/linkedcare/StructureDefinition/at-core-ext-patient-religion']) &lt;= 1">extension with URL = 'http://fhir.hl7.at/linkedcare/StructureDefinition/at-core-ext-patient-religion': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address/f:line">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.at/linkedcare/StructureDefinition/at-core-ext-address-additionalInformation']) &lt;= 1">extension with URL = 'http://fhir.hl7.at/linkedcare/StructureDefinition/at-core-ext-address-additionalInformation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
