...
```json
{
  ...
  "id" : "hl7.at.fhir.brz.providerdirectory.r4",
  "url" : "http://fhir.hl7.at/brz/providerdirectory/r4/ImplementationGuide/hl7.at.fhir.brz.providerdirectory.r4",
  "version" : "0.1.0",
  ...
  "packageId" : "hl7.at.fhir.brz.providerdirectory.r4",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://fhir.hl7.at/brz/providerdirectory/r4/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-BRZPDPractitioner.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/BRZPDPractitioner"
      },
    ...
    },
    {
      ...
      "description" : "An example of a pd practitioner profile.",
      "exampleCanonical" : "http://fhir.hl7.at/brz/providerdirectory/r4/StructureDefinition/BRZPDPractitioner"
    }],
    "page" : {
      "extension" : [{
