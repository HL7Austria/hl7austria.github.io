...
Profiles: [AT MOPED Procedure Basis Profil](StructureDefinition-at-moped-procedure-basis.md), `https://elga.moped.at/StructureDefinition/AtMopedProcedureBasis`
...
```json
{
  ...
  "meta" : {
    ...
    "https://elga.moped.at/StructureDefinition/AtMopedProcedureBasis"]
  },
  "extension" : [{
