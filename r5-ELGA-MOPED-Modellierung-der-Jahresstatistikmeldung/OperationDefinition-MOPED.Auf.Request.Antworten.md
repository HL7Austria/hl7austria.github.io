...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_Auf_Request_Antworten |
...
```json
{
  ...
  "parameter" : [{
    ...
    "type" : "Bundle",
    "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-bundle-antworten-SV"]
  },
  {
    "name" : "return",
    "use" : "out",
