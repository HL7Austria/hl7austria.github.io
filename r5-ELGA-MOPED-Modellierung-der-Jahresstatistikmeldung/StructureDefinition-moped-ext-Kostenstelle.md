...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:Kostenstelle |
...
* Use this Extension: [AT MOPED Organization Organisationseinheite KA Profil](StructureDefinition-at-moped-organization-organisationseinheit-KA.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-Kostenstelle.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-organization-organisationseinheit-KA#HealthcareService"
  }],
  "type" : "Extension",
