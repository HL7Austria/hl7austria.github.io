...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:Altersgruppe |
...
* Use this Extension: [AT MOPED Encounter Aufenthalt/Besuch generisches Profil](StructureDefinition-at-moped-encounter-aufenthaltbesuch-generisch.md) and [AT MOPED Encounter Bewegung generisches Profil](StructureDefinition-at-moped-encounter-bewegung-generisch.md)
* Examples for this Extension: [Encounter/BewegungsEncounter42.1](Encounter-BewegungsEncounter42.1.md), [Encounter/BewegungsEncounter42.2](Encounter-BewegungsEncounter42.2.md), [Encounter/Encounter42](Encounter-Encounter42.md), [Encounter/PJ1BewegungsEncounter1](Encounter-PJ1BewegungsEncounter1.md)... Show 6 more, [Encounter/PJ1BewegungsEncounter1Aufnahme](Encounter-PJ1BewegungsEncounter1Aufnahme.md), [Encounter/PJ2BewegungsEncounter1](Encounter-PJ2BewegungsEncounter1.md), [Encounter/PJ2BewegungsEncounter2](Encounter-PJ2BewegungsEncounter2.md), [Encounter/PJ2BewegungsEncounter3](Encounter-PJ2BewegungsEncounter3.md), [Encounter/PJ2BewegungsEncounter4](Encounter-PJ2BewegungsEncounter4.md) and [Encounter/PJ2BewegungsEncounter5](Encounter-PJ2BewegungsEncounter5.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-altersgruppe.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-encounter-bewegung-generisch#Encounter.admission"
  },
  {
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-encounter-aufenthaltbesuch-generisch#Encounter"
  }],
  "type" : "Extension",
