...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile AtMopedEncounterBewegungGenerisch
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:subjectStatus) &gt;= 1">subjectStatus: minimum cardinality of 'subjectStatus' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:admission/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'neugeborenes']) &lt;= 0">extension with URL = 'neugeborenes': maximum cardinality of 'extension' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
