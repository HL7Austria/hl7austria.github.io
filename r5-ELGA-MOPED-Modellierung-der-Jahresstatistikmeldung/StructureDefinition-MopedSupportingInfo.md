# ELGA.MOPED\Supporting Info Extension for ClaimResponse - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Supporting Info Extension for ClaimResponse**

## Extension: Supporting Info Extension for ClaimResponse 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/StructureDefinition/MopedSupportingInfo | *Version*:0.1.0 | |
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedSupportingInfo |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-MopedSupportingInfo.json)
...
Other representations of profile: [CSV](StructureDefinition-MopedSupportingInfo.csv), [Excel](StructureDefinition-MopedSupportingInfo.xlsx), [Schematron](StructureDefinition-MopedSupportingInfo.sch) 
...
```json
{
  ...
  "id" : "MopedSupportingInfo",
  "extension" : [{
    "url" : "http://hl7.org/fhir/StructureDefinition/structuredefinition-type-characteristics",
    "valueCode" : "can-bind"
  }],
  "url" : "https://elga.moped.at/StructureDefinition/MopedSupportingInfo",
  "version" : "0.1.0",
  "name" : "MopedSupportingInfo",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://elga.moped.at/StructureDefinition/MopedSupportingInfo"
    },
    {
