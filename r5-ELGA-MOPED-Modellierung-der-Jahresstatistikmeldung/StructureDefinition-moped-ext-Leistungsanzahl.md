...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:Leistungsanzahl |
...
* Use this Extension: [AT MOPED Procedure generisches Profil](StructureDefinition-at-moped-procedure-generisch.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-Leistungsanzahl.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-procedure-generisch#Procedure"
  }],
  "type" : "Extension",
