...
Profiles: [AT MOPED Claim VAERequest generisches Profil](StructureDefinition-at-moped-claim-vaerequest-generisch.md), `https://elga.moped.at/StructureDefinition/AtMopedClaimVAERequestGenerisch`
...
* [Encounter: status = completed; type = Moped Bewegungsencounter; subjectStatus = physisch anwesend; actualPeriod = 2024-08-08 08:21:00+0200 --> 2024-08-08 11:22:00+0200](Encounter-PJ2BewegungsEncounter1.md)
...
```json
{
  ...
  "meta" : {
    ...
    "https://elga.moped.at/StructureDefinition/AtMopedClaimVAERequestGenerisch"]
  },
  "status" : "active",
  "type" : {
    "coding" : [{
