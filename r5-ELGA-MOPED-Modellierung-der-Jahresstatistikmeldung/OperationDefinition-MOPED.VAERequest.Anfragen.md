...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_VAERequest_Anfragen |

 
Die $anfragen Operation wird aufgerufen, um die Versichertenanspruchserklärung-Anfrage an die SV anzustoßen. Diese Operation ist irrelevant für Selbstzahler (-> wenn es keine zuständige SV gibt darf die Operation $anfragen nicht ausgeführt werden). 
...
```json
{
  ...
  "parameter" : [{
    ...
    "type" : "Bundle",
    "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-bundle-anfragen-KA"]
  },
  {
    "name" : "return",
    "use" : "out",
