...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_Claim_Melden |
...
```json
{
  ...
  "parameter" : [{
    ...
    "type" : "Bundle",
    "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-bundle-melden-LGF"]
  },
  {
    "name" : "return",
    "use" : "out",
