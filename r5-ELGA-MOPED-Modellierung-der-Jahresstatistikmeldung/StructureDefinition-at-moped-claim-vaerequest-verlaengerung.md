# ELGA.MOPED\AT MOPED Claim VAERequest Verlängerungs Profil - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AT MOPED Claim VAERequest Verlängerungs Profil**

## Resource Profile: AT MOPED Claim VAERequest Verlängerungs Profil 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/StructureDefinition/at-moped-claim-vaerequest-verlaengerung | *Version*:0.1.0 | |
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:AtMopedClaimVAERequestVerlaengerung |

 
MOPED Profil der Claim Ressource für die Verlängerung der Versichertenanspruchserklärung (VAE) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-at-moped-claim-vaerequest-verlaengerung.json)
...
Other representations of profile: [CSV](StructureDefinition-at-moped-claim-vaerequest-verlaengerung.csv), [Excel](StructureDefinition-at-moped-claim-vaerequest-verlaengerung.xlsx), [Schematron](StructureDefinition-at-moped-claim-vaerequest-verlaengerung.sch) 
...
```json
{
  ...
  "url" : "https://elga.moped.at/StructureDefinition/at-moped-claim-vaerequest-verlaengerung",
  "version" : "0.1.0",
  "name" : "AtMopedClaimVAERequestVerlaengerung",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "code" : "Reference",
        "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-claim-vaerequest-verlaengerung"]
      }]
    },
    {
