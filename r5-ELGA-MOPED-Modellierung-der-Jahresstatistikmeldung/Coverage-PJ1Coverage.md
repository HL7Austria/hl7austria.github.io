...
Profiles: [AT MOPED Coverage Versicherter Basis Profil](StructureDefinition-at-moped-coverage-versicherter-basis.md), `https://elga.moped.at/StructureDefinition/AtMopedCoverageVersicherterBasis`
...
```json
{
  ...
  "meta" : {
    ...
    "https://elga.moped.at/StructureDefinition/AtMopedCoverageVersicherterBasis"]
  },
  "identifier" : [{
