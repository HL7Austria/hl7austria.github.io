...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:DiagnoseKnoten |
...
* Use this Extension: [MOPED ARKRequest](StructureDefinition-MopedARKRequest.md) and [AT MOPED Claim LKFRequest generisches Profil](StructureDefinition-at-moped-claim-lkfrequest-generisch.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-diagnoseKnoten.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-claim-lkfrequest-generisch#Claim"
  },
  {
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-claimresponse-lkfresponse-generisch#ClaimResponse"
  }],
  "type" : "Extension",
