...
Profiles: [AT MOPED Organization KA Profil](StructureDefinition-at-moped-organization-KA.md), `https://elga.moped.at/StructureDefinition/AtMopedOrganizationKA`
...
```json
{
  ...
  "meta" : {
    ...
    "https://elga.moped.at/StructureDefinition/AtMopedOrganizationKA"]
  },
  "identifier" : [{
