...
Profiles: `https://elga.moped.at/StructureDefinition/AtMopedOrganizationKA`, [HL7® AT Core Organization Profile](https://build.fhir.org/ig/HL7Austria/HL7-AT-FHIR-Core-R5/StructureDefinition-at-core-organization.html)
...
```json
{
  ...
  "id" : "KAK999",
  "meta" : {
    "profile" : ["https://elga.moped.at/StructureDefinition/AtMopedOrganizationKA",
