...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_Encounter_Abrechnen |
...
1. Der AtMopedClaimLKFRequestBasis wird lt. Regeln validiert und erstellt
...
```json
{
  ...
  "parameter" : [{
    ...
    "type" : "Bundle",
    "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-bundle-abrechnen-KA"]
  },
  {
    "name" : "return",
    "use" : "out",
