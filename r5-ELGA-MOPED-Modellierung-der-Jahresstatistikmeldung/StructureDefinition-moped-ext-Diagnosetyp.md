...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:Diagnosetyp |
...
* Use this Extension: [AT MOPED Condition generisches Profil](StructureDefinition-at-moped-condition-generisch.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-Diagnosetyp.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-condition-generisch#Condition"
  }],
  "type" : "Extension",
