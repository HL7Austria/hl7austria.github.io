...
Profiles: [AT MOPED Claim LKFRequest Basis Profil](StructureDefinition-at-moped-claim-lkfrequest-basis.md), `https://elga.moped.at/StructureDefinition/AtMopedClaimLKFRequestBasis`
...
```json
{
  ...
  "meta" : {
    ...
    "https://elga.moped.at/StructureDefinition/AtMopedClaimLKFRequestBasis"]
  },
  "extension" : [{
