...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:TageOhneKostenbeitrag |
...
* Use this Extension: [AT MOPED Encounter Aufenthalt Stationär Basis Profil](StructureDefinition-at-moped-encounter-aufenthalt-stationaer-basis.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-TageOhneKostenbeitrag.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-composition-generisch#Composition"
  }],
  "type" : "Extension",
