# ELGA.MOPED\AT MOPED Condition generisches Profil - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AT MOPED Condition generisches Profil**

## Resource Profile: AT MOPED Condition generisches Profil 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/StructureDefinition/at-moped-condition-generisch | *Version*:0.1.0 | |
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:AtMopedConditionGenerisch |

 
MOPED generisches Profil der Condition Ressource für Diagnosen 

**Usages:**

* Derived from this Profile: [AT MOPED Condition Basis Profil](StructureDefinition-at-moped-condition-basis.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-at-moped-condition-generisch.json)
...
Other representations of profile: [CSV](StructureDefinition-at-moped-condition-generisch.csv), [Excel](StructureDefinition-at-moped-condition-generisch.xlsx), [Schematron](StructureDefinition-at-moped-condition-generisch.sch) 
...
```json
{
  ...
  "url" : "https://elga.moped.at/StructureDefinition/at-moped-condition-generisch",
  "version" : "0.1.0",
  "name" : "AtMopedConditionGenerisch",
