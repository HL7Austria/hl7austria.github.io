...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_QuestionnaireResponse_Einmelden |
...
```json
{
  ...
  "parameter" : [{
    ...
    "type" : "Bundle",
    "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-bundle-questionnaireresponse-einmelden-KA"]
  },
  {
    "name" : "return",
    "use" : "out",
