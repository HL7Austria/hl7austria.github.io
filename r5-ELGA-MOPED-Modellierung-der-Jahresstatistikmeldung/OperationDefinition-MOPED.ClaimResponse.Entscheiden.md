...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_ClaimResponse_Entscheiden |
...
```json
{
  ...
  "parameter" : [{
    ...
    "type" : "Bundle",
    "targetProfile" : ["https://elga.moped.at/StructureDefinition/at-moped-bundle-entscheiden-LGF"]
  },
  {
    "name" : "return",
    "use" : "out",
