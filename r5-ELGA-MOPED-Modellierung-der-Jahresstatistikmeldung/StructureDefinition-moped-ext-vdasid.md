...
| Draft as of 2026-06-09 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:VDASID |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/elga.moped|current/StructureDefinition/StructureDefinition-moped-ext-vdasid.json)
...
```json
{
  ...
  "context" : [{
    "type" : "element",
    "expression" : "https://elga.moped.at/StructureDefinition/at-moped-coverage-versicherter-basis#Coverage"
  }],
  "type" : "Extension",
