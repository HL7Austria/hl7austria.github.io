...
| Draft as of 2026-09-08 | *Responsible:*[ELGA GmbH](http://elga.gv.at) | *Computable Name*:AtReported |
...
* Examples for this Extension: [AllergyIntolerance/AllergyExample](AllergyIntolerance-AllergyExample.md), [Condition/DiagnoseCurrentlyRelevantExample](Condition-DiagnoseCurrentlyRelevantExample.md), [Condition/DiagnoseEnteredInErrorExample](Condition-DiagnoseEnteredInErrorExample.md), [Condition/DiagnoseNotCurrentlyRelevantExample](Condition-DiagnoseNotCurrentlyRelevantExample.md) and [Procedure/ProcedureExample](Procedure-ProcedureExample.md)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-08T09:35:12+00:00",
  "publisher" : "ELGA GmbH",
  "contact" : [{
    "name" : "ELGA GmbH",
    "telecom" : [{
