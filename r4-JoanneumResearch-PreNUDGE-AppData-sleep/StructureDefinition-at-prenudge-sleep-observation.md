...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/prenudge/appdata/r4/StructureDefinition/at-prenudge-sleep-observation | *Version*:0.1.0 | |
| Draft as of 2026-05-27 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:AtPrenudgeObservationSleepDuration |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.prenudge.appdata.r4|current/StructureDefinition/StructureDefinition-at-prenudge-sleep-observation.json)
...
Other representations of profile: [CSV](StructureDefinition-at-prenudge-sleep-observation.csv), [Excel](StructureDefinition-at-prenudge-sleep-observation.xlsx), [Schematron](StructureDefinition-at-prenudge-sleep-observation.sch) 
...
```json
{
  ...
  "url" : "https://fhir.hl7.at/prenudge/appdata/r4/StructureDefinition/at-prenudge-sleep-observation",
  "version" : "0.1.0",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://fhir.hl7.at/prenudge/appdata/r4/StructureDefinition/at-prenudge-sleep-observation"
      }]
    },
    {
      "id" : "Observation.code",
