# Input Observation: Oxygen Saturation (1) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Input Observation: Oxygen Saturation (1)**

## Example Observation: Input Observation: Oxygen Saturation (1)
...
```json
{
  ...
  "id" : "sc-01-ai-only-observation-oxygen-saturation-001",
  "status" : "final",
  "category" : [{
    "coding" : [{
