# HL7.AT.FHIR.CORE.R4\HL7® AT Core Base Patient Profile - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HL7® AT Core Base Patient Profile**

## Resource Profile: HL7® AT Core Base Patient Profile 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.at/fhir/HL7ATCoreProfiles/4.0.1/StructureDefinition/at-core-patient-base | *Version*:2.1.0 | |
| Active as of 2026-06-18 | *Responsible:*[HL7® Austria, TC FHIR®](https://hl7.at/technische-komitees/tc-fhir/) | *Computable Name*:HL7ATCorePatientBase |

 
HL7® Austria FHIR® Core Base Profile for patient data in Austria. 

**Usages:**

* Derived from this Profile: [HL7® AT Core Patient Profile for Primary Use](StructureDefinition-at-core-patient-primary.md) and [HL7® AT Core Patient Profile for Secondary Use](StructureDefinition-at-core-patient-secondary.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.core.r4|current/StructureDefinition/StructureDefinition-at-core-patient-base.json)
...
Other representations of profile: [CSV](StructureDefinition-at-core-patient-base.csv), [Excel](StructureDefinition-at-core-patient-base.xlsx), [Schematron](StructureDefinition-at-core-patient-base.sch) 
...
```json
{
  ...
  "url" : "http://hl7.at/fhir/HL7ATCoreProfiles/4.0.1/StructureDefinition/at-core-patient-base",
  "version" : "2.1.0",
  "name" : "HL7ATCorePatientBase",
