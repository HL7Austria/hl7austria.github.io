# AT APS Bundle - Austrian Patient Summary (R4) v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AT APS Bundle**

## Resource Profile: AT APS Bundle 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.hl7.at/elga/aps/r4/StructureDefinition/at-aps-bundle | *Version*:1.1.0 |
| Active as of 2026-09-01 | *Computable Name*:AtApsBundle |

 
Das AT APS-Profil für die Bundle-Ressource berücksichtigt zum einen die österreichischen Vorgaben (z.B. Patient und zu verwendende Value-Sets) und stellt andererseits die Konformität gegenüber dem IPS-Profil sicher, indem die so genannte [`imposeProfile`](http://hl7.org/fhir/StructureDefinition/structuredefinition-imposeProfile)-Erweiterung verwendet wird. 

**Usages:**

* Examples for this Profile: [Bundle/AtApsExample03Diabetes](Bundle-AtApsExample03Diabetes.md), [Bundle/AtApsExampleBundle-Journey-1](Bundle-AtApsExampleBundle-Journey-1.md), [Bundle/AtApsExampleBundle-Journey-2](Bundle-AtApsExampleBundle-Journey-2.md), [Bundle/AtApsExampleBundle-Journey-3](Bundle-AtApsExampleBundle-Journey-3.md)... Show 2 more, [Bundle/AtApsExampleBundle01NoProblemsMedicationAllergies](Bundle-AtApsExampleBundle01NoProblemsMedicationAllergies.md) and [Bundle/AtApsExampleBundle02PreventiveMedicalCheckup](Bundle-AtApsExampleBundle02PreventiveMedicalCheckup.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.elga.aps.r4|current/StructureDefinition/StructureDefinition-at-aps-bundle.json)
...
Other representations of profile: [CSV](StructureDefinition-at-aps-bundle.csv), [Excel](StructureDefinition-at-aps-bundle.xlsx), [Schematron](StructureDefinition-at-aps-bundle.sch) 
