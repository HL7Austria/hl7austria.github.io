# AT APS Observation Results Laboratory Pathology - Austrian Patient Summary (R4) v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AT APS Observation Results Laboratory Pathology**

## Resource Profile: AT APS Observation Results Laboratory Pathology 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.hl7.at/elga/aps/r4/StructureDefinition/at-aps-observationresultslaboratorypathology | *Version*:1.1.0 |
| Active as of 2026-09-01 | *Computable Name*:AtApsObservationResultsLaboratoryPathology |
...
* Refer to this Profile: [AT APS Composition](StructureDefinition-at-aps-composition.md), [AT APS DiagnosticReport](StructureDefinition-at-aps-diagnosticreport.md) and [AT APS Observation Results Laboratory Pathology](StructureDefinition-at-aps-observationresultslaboratorypathology.md)
* Examples for this Profile: [Observation/AtApsExampleObservationResultsLaboratoryPathology01](Observation-AtApsExampleObservationResultsLaboratoryPathology01.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.elga.aps.r4|current/StructureDefinition/StructureDefinition-at-aps-observationresultslaboratorypathology.json)
...
Other representations of profile: [CSV](StructureDefinition-at-aps-observationresultslaboratorypathology.csv), [Excel](StructureDefinition-at-aps-observationresultslaboratorypathology.xlsx), [Schematron](StructureDefinition-at-aps-observationresultslaboratorypathology.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://termgit.elga.gv.at/ValueSet/at-aps-observationinterpretation"
      }
    },
    {
