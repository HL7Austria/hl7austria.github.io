...
* Examples for this Extension: [AllergyIntolerance/AllergyExample](AllergyIntolerance-AllergyExample.md), [Condition/ConditionGesamtlisteExample](Condition-ConditionGesamtlisteExample.md), [Condition/ConditionSummaryExample](Condition-ConditionSummaryExample.md), [Condition/DiagnoseEnteredInErrorExample](Condition-DiagnoseEnteredInErrorExample.md) and [Procedure/ProcedureExample](Procedure-ProcedureExample.md)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-08T12:20:24+00:00",
  "publisher" : "ELGA GmbH",
  "contact" : [{
    "name" : "ELGA GmbH",
    "telecom" : [{
