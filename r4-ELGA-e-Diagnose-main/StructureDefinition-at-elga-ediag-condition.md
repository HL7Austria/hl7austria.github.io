...
| Active as of 2026-09-18 | *Responsible:*[ELGA GmbH](http://elga.gv.at) | *Computable Name*:AtEdiagCondition |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Condition.code",
      "path" : "Condition.code",
      "short" : "Diagnosecode (Codierservice); Freitext ist nicht zulässig.",
      "min" : 1,
      "mustSupport" : true,
      "binding" : {
        "strength" : "required",
