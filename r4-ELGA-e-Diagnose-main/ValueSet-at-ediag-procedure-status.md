# HL7.AT.FHIR.ELGA.EDIAG.R4\AT e-Diagnose Procedure Status Value Set - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AT e-Diagnose Procedure Status Value Set**

## ValueSet: AT e-Diagnose Procedure Status Value Set (Experimental) 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/elga/ediag/r4/ValueSet/at-ediag-procedure-status | *Version*:0.1.0 | |
| Active as of 2026-07-28 | *Responsible:*[ELGA GmbH](http://elga.gv.at) | *Computable Name*:AtEdiagProcedureStatus |
