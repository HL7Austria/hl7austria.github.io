...
| | |
| :--- | :--- |
| [AT e-Diagnose AllergyIntolerance Code](ValueSet-at-ediag-allergyintolerance-code.md) | Value-Set für die Codierung von Allergien und Intoleranzen. |
| [AT e-Diagnose Condition Code](ValueSet-at-ediag-condition-code.md) | Value-Set für die Codierung von Diagnosen. |
| [AT e-Diagnose Procedure Code](ValueSet-at-ediag-procedure-code.md) | Value-Set für die Codierung von Prozeduren. |
