...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/tc/wg/scheduling/r5/StructureDefinition/virtual-service-detail | *Version*:1.1.0 | |
| Draft as of 2026-09-01 | *Responsible:*HL7® Austria, TC FHIR® | *Computable Name*:VirtualServiceDetailExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.tc.wg.scheduling.r5|current/StructureDefinition/StructureDefinition-virtual-service-detail.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://fhir.hl7.at/tc/wg/scheduling/r5/StructureDefinition/virtual-service-detail"
    },
    {
