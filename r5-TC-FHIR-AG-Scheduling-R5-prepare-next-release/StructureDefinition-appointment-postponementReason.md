...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/tc/wg/scheduling/r5/StructureDefinition/appointment-postponementReason | *Version*:1.1.0 | |
| Draft as of 2026-09-01 | *Responsible:*HL7® Austria, TC FHIR® | *Computable Name*:AppointmentPostponementReasonExt |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.tc.wg.scheduling.r5|current/StructureDefinition/StructureDefinition-appointment-postponementReason.json)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-01T06:35:53+00:00",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://fhir.hl7.at/tc/wg/scheduling/r5/StructureDefinition/appointment-postponementReason"
    },
    {
