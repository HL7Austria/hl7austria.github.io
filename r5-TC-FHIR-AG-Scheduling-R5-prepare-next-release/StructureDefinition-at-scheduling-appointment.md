...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/tc/wg/scheduling/r5/StructureDefinition/at-scheduling-appointment | *Version*:1.1.0 | |
| Draft as of 2026-09-01 | *Responsible:*HL7® Austria, TC FHIR® | *Computable Name*:HL7ATSchedulingAppointment |

 
HL7® Austria FHIR® Scheduling Profile for appointment data in Austria. 

This Profile is used in the [Find existing Appointments](functional-transactions.md#find-existing-appointments) and the [$book Operation](OperationDefinition-appointment-book.md).
