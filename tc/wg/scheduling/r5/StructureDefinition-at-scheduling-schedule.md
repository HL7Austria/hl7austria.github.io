...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/tc/wg/scheduling/r5/StructureDefinition/at-scheduling-schedule | *Version*:1.0.0 | |
| Draft as of 2026-08-31 | *Responsible:*HL7® Austria, TC FHIR® | *Computable Name*:HL7ATSchedulingSchedule |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.tc.wg.scheduling.r5|current/StructureDefinition/StructureDefinition-at-scheduling-schedule.json)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-08-31T12:31:41+00:00",
