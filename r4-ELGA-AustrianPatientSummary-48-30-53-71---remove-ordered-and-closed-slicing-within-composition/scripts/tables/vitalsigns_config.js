export const i_vitalsigns_config = {
  ...
  columns: [
    ...
    {
      title: "Codesystem<br>Test",
      field: "codesystemTest",
      formatter: function (cell) {
        const row_data = cell.getRow().getData();
        const codesystem_type_test = row_data?.codesystem_type_test;
        const url = cell.getValue();
        return url == '-' ? '-' : `<a href="${url}" target="_blank" class="a-explanation">${codesystem_type_test || url}</a>`
      },
      cssClass: "wrap-text",
      responsive: 4,
      width: 250,
...
export const v_vitalsigns_config = {
  layout: "fitDataStretch",
  responsiveLayout: "collapse",
  rowHeader: {
    formatter: "responsiveCollapse",
