...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/prenudge/appdata/r4/Questionnaire/StepCountQuantityQuestionnaire | *Version*:0.1.0 | |
| Active as of 2026-06-24 | *Responsible:*[The PreNUDGE Consortium](https://prenudge.at) | *Computable Name*:StepCountQuantityQuestionnaire |
...
```json
{
  ...
  "id" : "StepCountQuantityQuestionnaire",
  "meta" : {
