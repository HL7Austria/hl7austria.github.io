...
| Draft as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedMeldenLGFBundle |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Bundle.entry:ARKReq.resource",
      ...
      {
        "id" : "Bundle.entry:ARKReq.request.method",
