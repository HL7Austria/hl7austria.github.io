...
## ValueSet: Workflow Status eines Falls (Experimental) 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/ValueSet/WorkflowStatusVS | *Version*:0.1.0 | |
| Draft as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:WorkflowStatusVS |
...
* Include all codes defined in [`https://elga.moped.at/CodeSystem/WorkflowStatusCS`](CodeSystem-WorkflowStatusCS.md)version 📦0.1.0
