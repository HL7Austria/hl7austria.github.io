...
| Active as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:CompositionSectionsCS |
...
```json
{
  ...
  "concept" : [
    ...
    {
      "code" : "ARKReq",
      "display" : "ARK Requests"
    },
    {
      "code" : "ARKResp",
      "display" : "ARK Responses"
    },
    {
      "code" : "ARKPay",
