...
| Draft as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_Patient_Entlassen |
...
URL: [base]/Composition/[id]/$entlassen
...
* **Use**: IN
  ...
  * **Scope**: 
  * **Cardinality**: 1..1
  * **Type**: [Bundle](http://hl7.org/fhir/R5/bundle.html)([MOPED Entlassen Bundle KH](StructureDefinition-MopedEntlassenBundle.md))
  * **Binding**: 
