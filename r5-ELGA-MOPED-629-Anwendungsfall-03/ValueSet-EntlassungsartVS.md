...
| Draft as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:EntlassungsartVS |
...
* Import all the codes that are contained in [Entlassungsart des Patienten ambulant](ValueSet-EntlassungsartAVS.md)
* Import all the codes that are contained in [Entlassungsart des Patienten stationär](ValueSet-EntlassungsartSVS.md)
