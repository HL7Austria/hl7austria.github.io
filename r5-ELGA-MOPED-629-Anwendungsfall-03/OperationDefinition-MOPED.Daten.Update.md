...
| Draft as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MOPED_Daten_Update |
...
URL: [base]/Composition/[id]/$update
...
* **Use**: IN
  ...
  * **Scope**: 
  * **Cardinality**: 1..1
  * **Type**: [Bundle](http://hl7.org/fhir/R5/bundle.html)([MOPED Update Bundle KH](StructureDefinition-MopedUpdateBundleKH.md))
  * **Binding**: 
