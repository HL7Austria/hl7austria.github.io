...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'https://elga.moped.at/StructureDefinition/moped-ext-Diagnosetyp']) &gt;= 1">extension with URL = 'https://elga.moped.at/StructureDefinition/moped-ext-Diagnosetyp': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://elga.moped.at/StructureDefinition/moped-ext-Diagnosetyp']) &lt;= 2">extension with URL = 'https://elga.moped.at/StructureDefinition/moped-ext-Diagnosetyp': maximum cardinality of 'extension' is 2</sch:assert>
