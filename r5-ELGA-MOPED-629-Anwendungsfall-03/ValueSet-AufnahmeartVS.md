# ELGA.MOPED\Aufnahmeart des Patienten - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Aufnahmeart des Patienten**

## ValueSet: Aufnahmeart des Patienten (Experimental) 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://elga.moped.at/ValueSet/AufnahmeartVS | *Version*:0.1.0 | |
| Draft as of 2025-10-15 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:AufnahmeartVS |
...
* Include all codes defined in [`https://elga.moped.at/CodeSystem/AufnahmeartCS`](CodeSystem-AufnahmeartCS.md)version 📦0.1.0
...
```json
{
  ...
  "id" : "AufnahmeartVS",
  "url" : "https://elga.moped.at/ValueSet/AufnahmeartVS",
  "version" : "0.1.0",
  "name" : "AufnahmeartVS",
