...
| :--- | :--- | :--- |
| - | **Code** | **Value[x]** |
| * | [UsageContextType workflow](http://terminology.hl7.org/6.5.0/CodeSystem-usage-context-type.html#usage-context-type-workflow): Workflow Setting | Endgültige Freigabe |
