...
| Draft as of 2025-12-19 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedAbrechnenBundleKH |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Bundle.entry:LKFReq.resource",
      ...
      {
        "id" : "Bundle.entry:LKFReq.request.method",
