...
| Draft as of 2025-12-19 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedAnfragenBundleKH |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Bundle.entry:VAEReq.resource",
      ...
      {
        "id" : "Bundle.entry:VAEReq.request.method",
