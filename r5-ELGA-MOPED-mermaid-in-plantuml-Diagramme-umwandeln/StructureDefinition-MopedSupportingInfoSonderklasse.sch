...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'sequence']) &gt;= 1">extension with URL = 'sequence': minimum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'timing']) &gt;= 1">extension with URL = 'timing': minimum cardinality of 'extension' is 1</sch:assert>
