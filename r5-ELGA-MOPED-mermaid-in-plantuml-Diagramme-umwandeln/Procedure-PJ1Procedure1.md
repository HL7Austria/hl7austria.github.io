...
| :--- | :--- | :--- |
| - | **Actor** | **OnBehalfOf** |
| * | [Organization: extension = ; identifier = http://example.org/lkf-system/funktionscode#131180,http://example.org/lkf-system/funktionssubcode#00; type = Hospital Department](Organization-AbteilungHerzJesu1.md) | [Organization Herz Jesu-Krankenhaus](Organization-OrganizationHerzJesuKrankenhaus.md) |
