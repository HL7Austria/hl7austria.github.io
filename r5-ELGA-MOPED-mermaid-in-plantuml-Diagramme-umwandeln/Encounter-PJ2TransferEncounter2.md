# ELGA.MOPED\PJ2TransferEncounter2 - FHIR® v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PJ2TransferEncounter2**

## Example Encounter: PJ2TransferEncounter2
...
**serviceProvider**: [Organization: identifier = http://example.org/lkf-system/funktionscode#127181,http://example.org/lkf-system/funktionssubcode#00; type = Hospital Department](Organization-AbteilungKHRied2.md)

**actualPeriod**: 2024-08-08 11:22:00+0200 --> 2024-08-08 11:41:00+0200
...
```json
{
  ...
  "actualPeriod" : {
    "start" : "2024-08-08T11:22:00+02:00",
    "end" : "2024-08-08T11:41:00+02:00"
  },
  "admission" : {
    "extension" : [
      {
