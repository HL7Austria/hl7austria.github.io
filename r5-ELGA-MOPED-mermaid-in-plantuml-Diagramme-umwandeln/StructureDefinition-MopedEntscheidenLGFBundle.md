...
| Draft as of 2025-12-19 | *Responsible:*[ELGA GmbH](https://elga.gv.at) | *Computable Name*:MopedEntscheidenLGFBundle |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Bundle.entry:LKFResp.resource",
      ...
      {
        "id" : "Bundle.entry:LKFResp.request.method",
