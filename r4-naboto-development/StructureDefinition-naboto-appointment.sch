...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Appointment/f:participant">
      <sch:assert test="count(f:extension[@url = 'http://fhir.naboto.com/StructureDefinition/virtual-service-contact-detail']) &lt;= 1">extension with URL = 'http://fhir.naboto.com/StructureDefinition/virtual-service-contact-detail': maximum cardinality of 'extension' is 1</sch:assert>
