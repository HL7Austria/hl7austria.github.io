...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/core/r5/StructureDefinition/at-core-address | *Version*:2.1.0 | |
...
```json
{
  ...
  "id" : "at-core-address",
  "url" : "https://fhir.hl7.at/core/r5/StructureDefinition/at-core-address",
  "version" : "2.1.0",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://fhir.hl7.at/core/r5/StructureDefinition/at-core-address"
      },
      {
        "key" : "at-addr-2",
        "severity" : "error",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.hl7.at/core/r5/StructureDefinition/at-core-ext-address-municipalityCode"]
      }]
    },
    {
      "id" : "Address.line",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.hl7.at/core/r5/StructureDefinition/at-core-ext-address-additionalInformation"]
      }]
    },
    {
      "id" : "Address.district",
