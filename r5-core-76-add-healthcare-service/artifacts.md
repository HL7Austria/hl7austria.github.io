# HL7.AT.FHIR.CORE.R5\Artifacts Summary - FHIR® v5.0.0
...
| | |
| :--- | :--- |
| [HL7® AT Core HealthcareService Profile](StructureDefinition-at-core-HealthcareService.md) | HL7® Austria FHIR® Core Profile for healthcare service data in Austria. |
...
| [HL7® AT Core ExtendedContactDetail Profile](StructureDefinition-at-core-extendedContactDetail.md) | HL7® Austria FHIR® Core Profile to use the profile for address data in Austria on the datatype ExtendedContactDetail. |
...
| | |
| :--- | :--- |
| [Example HealthcareService with Specialty](HealthcareService-ExampleHealthcareService.md) | Example of a healthcare service with an Austrian Funktionscode as specialty. |
