...
| Draft as of 2025-11-18 | *Responsible:*HL7® Austria, TC FHIR® | *Computable Name*: |

 
A system providing the FHIR API for appointment booking and related data 

* **Actor: null**: A Scheduling Server provides data relevant to appointment scheduling (Healthcare Service Providers, Healthcare Services, available time slots, etc.) and offers services such as: creating patients, booking/editing/cancelling appointments.
...
```json
{
  ...
  "status" : "draft",
  "date" : "2025-11-18T18:41:09+00:00",
  "publisher" : "HL7® Austria, TC FHIR®",
  "description" : "A system providing the FHIR API for appointment booking and related data",
  "type" : "system",
  "documentation" : "A Scheduling Server provides data relevant to appointment scheduling (Healthcare Service Providers, Healthcare Services, available time slots, etc.) and offers services such as: creating patients, booking/editing/cancelling appointments."
}
