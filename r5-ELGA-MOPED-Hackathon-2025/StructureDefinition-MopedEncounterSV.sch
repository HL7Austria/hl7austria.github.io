...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:admission">
      ...
      <sch:assert test="count(f:extension[@url = 'https://elga.moped.at/StructureDefinition/moped-ext-transportart']) &lt;= 0">extension with URL = 'https://elga.moped.at/StructureDefinition/moped-ext-transportart': maximum cardinality of 'extension' is 0</sch:assert>
