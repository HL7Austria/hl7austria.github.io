...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Address/f:line">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.naboto.com/StructureDefinition/at-core-ext-address-additionalInformation']) &lt;= 1">extension with URL = 'http://fhir.naboto.com/StructureDefinition/at-core-ext-address-additionalInformation': maximum cardinality of 'extension' is 1</sch:assert>
