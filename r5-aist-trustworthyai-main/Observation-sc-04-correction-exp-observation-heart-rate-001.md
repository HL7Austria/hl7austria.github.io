# Input Observation: Heart Rate (4) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Input Observation: Heart Rate (4)**

## Example Observation: Input Observation: Heart Rate (4)
...
**value**: 112 beats/min (Details: UCUM code/min = '/min')
...
```json
{
  ...
  "id" : "sc-04-correction-exp-observation-heart-rate-001",
  "status" : "final",
  "category" : [{
    "coding" : [{
