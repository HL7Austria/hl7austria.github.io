# Trust AI Case-Specific Indication Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Case-Specific Indication Value Set**

## ValueSet: Trust AI Case-Specific Indication Value Set 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-case-specific-indication-vs | *Version*:0.1.0 |
| Active as of 2026-09-09 | *Computable Name*:TrustAICaseSpecificIndicationVS |
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-case-specific-indication-vs",
  "version" : "0.1.0",
  "name" : "TrustAICaseSpecificIndicationVS",
