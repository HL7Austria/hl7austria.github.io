# Input Observation: Oxygen Saturation (4) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Input Observation: Oxygen Saturation (4)**

## Example Observation: Input Observation: Oxygen Saturation (4)
...
```json
{
  ...
  "id" : "sc-04-correction-exp-observation-oxygen-saturation-001",
  "status" : "final",
  "category" : [{
    "coding" : [{
