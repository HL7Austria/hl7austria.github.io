# Provenance: AI Output Generation (3) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Provenance: AI Output Generation (3)**

## Example Provenance: Provenance: AI Output Generation (3)

Profile: [EU AI Provenance](StructureDefinition-eu-ai-provenance.md)

Provenance for [Observation ](Observation-sc-03-override-ai-observation-risk-001.md)
...
```json
{
  ...
  "id" : "sc-03-override-provenance-ai-output-001",
  "meta" : {
