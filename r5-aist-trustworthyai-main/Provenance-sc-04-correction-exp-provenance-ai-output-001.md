# Provenance: AI Output Generation (4) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Provenance: AI Output Generation (4)**

## Example Provenance: Provenance: AI Output Generation (4)

Profile: [EU AI Provenance](StructureDefinition-eu-ai-provenance.md)

Provenance for [Observation ](Observation-sc-04-correction-exp-ai-observation-risk-001.md)
...
```json
{
  ...
  "id" : "sc-04-correction-exp-provenance-ai-output-001",
  "meta" : {
