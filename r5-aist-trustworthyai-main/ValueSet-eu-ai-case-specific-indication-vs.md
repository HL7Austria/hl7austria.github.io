# EU AI Case-Specific Indication Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EU AI Case-Specific Indication Value Set**

## ValueSet: EU AI Case-Specific Indication Value Set 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/eu-ai-transparency/ValueSet/eu-ai-case-specific-indication-vs | *Version*:0.1.0 |
| Active as of 2026-07-31 | *Computable Name*:EUAICaseSpecificIndicationVS |
...
```json
{
  ...
  "url" : "http://example.org/fhir/eu-ai-transparency/ValueSet/eu-ai-case-specific-indication-vs",
  "version" : "0.1.0",
  "name" : "EUAICaseSpecificIndicationVS",
