# Trust AI Contact Purpose Code System - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Contact Purpose Code System**

## CodeSystem: Trust AI Contact Purpose Code System 
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/CodeSystem/trust-ai-contact-purpose-cs",
  "version" : "0.1.0",
  "name" : "TrustAIContactPurposeCodeSystem",
