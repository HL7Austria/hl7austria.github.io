...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      <sch:assert test="count(f:extension[@url = 'http://example.org/fhir/trust-ai-transparency/StructureDefinition/trust-ai-dpia-reference']) &lt;= 1">extension with URL = 'http://example.org/fhir/trust-ai-transparency/StructureDefinition/trust-ai-dpia-reference': maximum cardinality of 'extension' is 1</sch:assert>
