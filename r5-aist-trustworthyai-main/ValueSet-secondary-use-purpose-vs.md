# Secondary-Use Purpose Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Secondary-Use Purpose Value Set**

## ValueSet: Secondary-Use Purpose Value Set 
...
* [Secondary Use Purpose](StructureDefinition-secondary-use-purpose.md)
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/ValueSet/secondary-use-purpose-vs",
  "version" : "0.1.0",
  "name" : "SecondaryUsePurposeVS",
