# Input Observation: Respiratory Rate (4) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Input Observation: Respiratory Rate (4)**

## Example Observation: Input Observation: Respiratory Rate (4)
...
```json
{
  ...
  "id" : "sc-04-correction-exp-observation-respiratory-rate-001",
  "status" : "final",
  "category" : [{
    "coding" : [{
