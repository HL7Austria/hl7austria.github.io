...
| :--- | :--- | :--- |
| - | **What** | **Role** |
| * | [Observation ](Observation-sc-01-ai-only-ai-observation-risk-001.md) | AI Output |
...
```json
{
  ...
  "id" : "sc-01-ai-only-audit-event-ai-execution-001",
  "meta" : {
  ...
  "extension" : [{
    ...
    "valueSignature" : {
      ...
      "data" : "c2hhMjU2LTFmNzg5N2U0ZWVmNDNlM2ZiYmY1M2U3MDgxYzEwYTA1ZTEyZjhhNDEzZGI5NDQxMzI0NDYzZGRhZDAzNDdlMjk="
    }
  }],
  "code" : {
    "coding" : [{
