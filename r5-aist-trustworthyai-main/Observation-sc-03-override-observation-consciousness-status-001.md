# Input Observation: Consciousness Status (3) - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Input Observation: Consciousness Status (3)**

## Example Observation: Input Observation: Consciousness Status (3)
...
```json
{
  ...
  "id" : "sc-03-override-observation-consciousness-status-001",
  "status" : "final",
  "code" : {
