# Trust AI Artifact Type Code System - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Artifact Type Code System**

## CodeSystem: Trust AI Artifact Type Code System 
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/CodeSystem/trust-ai-artifact-type-cs",
  "version" : "0.1.0",
  "name" : "TrustAIArtifactTypeCodeSystem",
