# EU AI Human Oversight Action Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EU AI Human Oversight Action Value Set**

## ValueSet: EU AI Human Oversight Action Value Set 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/eu-ai-transparency/ValueSet/eu-ai-human-oversight-action-vs | *Version*:0.1.0 |
| Active as of 2026-09-03 | *Computable Name*:EUAIHumanOversightActionVS |
...
```json
{
  ...
  "url" : "http://example.org/fhir/eu-ai-transparency/ValueSet/eu-ai-human-oversight-action-vs",
  "version" : "0.1.0",
  "name" : "EUAIHumanOversightActionVS",
