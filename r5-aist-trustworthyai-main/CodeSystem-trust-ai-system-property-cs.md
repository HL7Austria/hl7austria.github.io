# Trust AI System Property Code System - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI System Property Code System**

## CodeSystem: Trust AI System Property Code System 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/trust-ai-transparency/CodeSystem/trust-ai-system-property-cs | *Version*:0.1.0 |
| Active as of 2026-09-09 | *Computable Name*:TrustAISystemPropertyCodeSystem |
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/CodeSystem/trust-ai-system-property-cs",
  "version" : "0.1.0",
  "name" : "TrustAISystemPropertyCodeSystem",
