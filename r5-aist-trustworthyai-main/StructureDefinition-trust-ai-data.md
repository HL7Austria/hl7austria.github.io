# Trust AI Data - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Data**

## Resource Profile: Trust AI Data 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ig.trust.aitransparency|current/StructureDefinition/StructureDefinition-trust-ai-data.json)
...
Other representations of profile: [CSV](StructureDefinition-trust-ai-data.csv), [Excel](StructureDefinition-trust-ai-data.xlsx), [Schematron](StructureDefinition-trust-ai-data.sch) 
...
```json
{
  ...
  "id" : "trust-ai-data",
  "url" : "http://example.org/fhir/trust-ai-transparency/StructureDefinition/trust-ai-data",
  "version" : "0.1.0",
  "name" : "TrustAIData",
  "title" : "Trust AI Data",
  "status" : "draft",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-involvement-vs"
      }
    },
    {
      ...
      "min" : 1,
      "patternUri" : "http://example.org/fhir/trust-ai-transparency/CodeSystem/trust-ai-involvement-cs"
    }]
  }
}
