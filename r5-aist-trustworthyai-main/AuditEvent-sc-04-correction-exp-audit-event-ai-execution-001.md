# Audit Log: AI Execution Trace (4) - v0.1.0
...
| :--- | :--- | :--- |
| - | **What** | **Role** |
| * | [Observation ](Observation-sc-04-correction-exp-ai-observation-risk-001.md) | AI Output |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueSignature" : {
      ...
      "data" : "c2hhMjU2LWUwNTFjNDEzNmNhZWEwMmIyOTA5OWEyOWZhNzQ4Yzc3ZDgyNDNmNmEyYTRkMzllOTg3ODQ4ZDhlYzg3NGQ1MTA="
    }
  }],
  "code" : {
    "coding" : [{
