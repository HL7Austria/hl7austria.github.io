# Usage Category Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Usage Category Value Set**

## ValueSet: Usage Category Value Set 
...
* [Usage Category](StructureDefinition-usage-category.md)
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/ValueSet/usage-category-vs",
  "version" : "0.1.0",
  "name" : "UsageCategoryVS",
