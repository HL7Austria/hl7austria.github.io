# Trust AI Data Quality Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Data Quality Value Set**

## ValueSet: Trust AI Data Quality Value Set 
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-data-quality-vs",
  "version" : "0.1.0",
  "name" : "TrustAIDataQualityVS",
