# Trust AI Performance Metric Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Performance Metric Value Set**

## ValueSet: Trust AI Performance Metric Value Set 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-performance-metric-vs | *Version*:0.1.0 |
| Active as of 2026-09-09 | *Computable Name*:TrustAIPerformanceMetricVS |
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-performance-metric-vs",
  "version" : "0.1.0",
  "name" : "TrustAIPerformanceMetricVS",
