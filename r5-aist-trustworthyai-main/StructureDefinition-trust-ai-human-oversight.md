# Trust AI Human Oversight Assessment - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Human Oversight Assessment**

## Resource Profile: Trust AI Human Oversight Assessment 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ig.trust.aitransparency|current/StructureDefinition/StructureDefinition-trust-ai-human-oversight.json)
...
Other representations of profile: [CSV](StructureDefinition-trust-ai-human-oversight.csv), [Excel](StructureDefinition-trust-ai-human-oversight.xlsx), [Schematron](StructureDefinition-trust-ai-human-oversight.sch) 
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/StructureDefinition/trust-ai-human-oversight",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "requirements" : "AI Act Art. 14 | Type of Intervention",
      "min" : 1,
      "max" : "1",
      "mustSupport" : true,
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-human-oversight-action-vs"
      }
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://example.org/fhir/trust-ai-transparency/StructureDefinition/trust-ai-practitionerrole"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "requirements" : "AI Act Art. 14 | Case-Specific Interpretability Information"
    }]
  }
}
