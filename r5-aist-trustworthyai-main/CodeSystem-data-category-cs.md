# Data Category Code System - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Data Category Code System**

## CodeSystem: Data Category Code System 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/trust-ai-transparency/CodeSystem/data-category-cs | *Version*:0.1.0 |
| Active as of 2026-09-09 | *Computable Name*:DataCategoryCodeSystem |
...
* [Data Category Value Set](ValueSet-data-category-vs.md)
...
```json
{
  ...
  "id" : "data-category-cs",
  "url" : "http://example.org/fhir/trust-ai-transparency/CodeSystem/data-category-cs",
  "version" : "0.1.0",
  "name" : "DataCategoryCodeSystem",
