# Trust AI Audit Entity Role Value Set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Trust AI Audit Entity Role Value Set**

## ValueSet: Trust AI Audit Entity Role Value Set 
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/ValueSet/trust-ai-audit-entity-role-vs",
  "version" : "0.1.0",
