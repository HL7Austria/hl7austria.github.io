...
```json
{
  ...
  "id" : "sc-03-override-audit-event-ai-execution-001",
  "meta" : {
  ...
  "extension" : [{
    ...
    "valueSignature" : {
      ...
      "data" : "c2hhMjU2LWJiMDBlZjdhYzRjZjZiNGQxNjY2MjNkZTE5ZTgyOGVjNzJkOTIzZjRjYzg5MWI1MDEzODg4NzgwNjFmNmViYzQ="
    }
  }],
  "code" : {
    "coding" : [{
