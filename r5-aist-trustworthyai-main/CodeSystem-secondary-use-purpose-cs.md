# Secondary-Use Purpose Code System - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Secondary-Use Purpose Code System**

## CodeSystem: Secondary-Use Purpose Code System 
...
* [Secondary-Use Purpose Value Set](ValueSet-secondary-use-purpose-vs.md)
...
```json
{
  ...
  "url" : "http://example.org/fhir/trust-ai-transparency/CodeSystem/secondary-use-purpose-cs",
  "version" : "0.1.0",
  "name" : "SecondaryUsePurposeCodeSystem",
