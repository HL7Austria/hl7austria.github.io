...
| [HL7® AT Core Patient Profile for Secondary Use](StructureDefinition-at-core-patient-secondary.md) | HL7® Austria FHIR® Core Profile for FHIR Patients without patient-identifying data in Austria. |
