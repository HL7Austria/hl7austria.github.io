...
| Active as of 2026-09-11 | *Responsible:*[HL7® Austria, TC FHIR®](https://hl7.at/technische-komitees/tc-fhir/) | *Computable Name*:HL7ATCoreAddress |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Address.extension:municipalityKey",
      "path" : "Address.extension",
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.hl7.at/core/r4/StructureDefinition/at-core-ext-address-municipalityKey"]
      }]
    },
    {
      "id" : "Address.line",
