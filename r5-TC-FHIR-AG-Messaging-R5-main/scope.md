...
Actors are mainly sending and receiving systems that might be integrated in e.g. a practitioners or hospitals healthcare information system. ODER soll man hier konkrete Einrichtungen nennen: Krankenhaus, niedergelassener Arzt, Facharzt, …
...
This section refers to all FHIR-based components of the Implementation Guide. • Actor Definitions • Message Definitions • Definition of Messaging Profiles (Structures: Resource Profiles and Data Type Profiles) • Terminology (Code Systems and Value Sets) • Examples
