...
| Active as of 2026-06-19 | *Responsible:*[HL7® Austria, TC FHIR®](https://hl7.at/technische-komitees/tc-fhir/) | *Computable Name*:HL7ATCoreLocation |
...
```json
{
  ...
  "id" : "at-core-location",
  "url" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-location",
  "version" : "2.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-location"
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "code" : "Reference",
        "targetProfile" : ["http://hl7.at/fhir/HL7ATCoreProfiles/5.0.0/StructureDefinition/at-core-location"]
      }]
    }]
  }
}
