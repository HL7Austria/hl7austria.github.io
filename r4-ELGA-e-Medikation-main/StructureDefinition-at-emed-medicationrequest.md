# HL7.AT.FHIR.ELGA.EMED.R4\ELGA e-Medikation MedicationRequest - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ELGA e-Medikation MedicationRequest**

## Resource Profile: ELGA e-Medikation MedicationRequest 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/elga/emed/r4/StructureDefinition/at-emed-medicationrequest | *Version*:0.1.1 | |
| Draft as of 2026-01-13 | *Responsible:*[ELGA GmbH](http://elga.gv.at) | *Computable Name*:AtEmedMedicationRequest |
...
* Examples for this Profile: [MedicationRequest/AtEmedExampleMedicationRequest01](MedicationRequest-AtEmedExampleMedicationRequest01.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.at.fhir.elga.emed.r4|current/StructureDefinition/at-emed-medicationrequest)
...
Other representations of profile: [CSV](StructureDefinition-at-emed-medicationrequest.csv), [Excel](StructureDefinition-at-emed-medicationrequest.xlsx), [Schematron](StructureDefinition-at-emed-medicationrequest.sch) 
...
```json
{
  ...
  "url" : "https://fhir.hl7.at/elga/emed/r4/StructureDefinition/at-emed-medicationrequest",
  "version" : "0.1.1",
  "name" : "AtEmedMedicationRequest",
  ...
  "baseDefinition" : "http://hl7.eu/fhir/mpd/StructureDefinition/MedicationRequest-eu-mpd",
