# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Journey 07-01: Planeintrag 2 - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Journey 07-01: Planeintrag 2**

## Example MedicationRequest: Beispiel Journey 07-01: Planeintrag 2
...
```json
{
  ...
  "medicationReference" : {
    "reference" : "#contained-medication-journey-07-01-02-magistral"
  },
  "subject" : {
