...
| Planeintrag beibehalten/zur Kenntnis nehmen | **Unchanged** | **active** | Bestehender Planeintrag bleibt unverändert* der Behandlungszeitraum darf noch nicht abgelaufen sein |   |
|   |   | **on-hold** | wie**active** |   |
...
| Planeintrag entfernen | **Removed** | **completed** | Bestehender Planeintrag wird beendet (durch Ablauf des Behandlungszeitraums,wenn keine erneute Verordnung) TODO: fachlich prüfen, ob dieser Status benötigt wird |   |
