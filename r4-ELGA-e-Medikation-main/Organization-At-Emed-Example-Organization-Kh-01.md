# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Organisation Krankenhaus 01 - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Organisation Krankenhaus 01**

## Example Organization: Beispiel Organisation Krankenhaus 01
...
**address**: Krankenhaus-Straße 1-7 Haupteingang St. Wolfgang Salzburg 5350 AUT (work)
...
```json
{
  ...
  "id" : "At-Emed-Example-Organization-Kh-01",
  "meta" : {
  ...
  "address" : [{
    "use" : "work",
    "type" : "both",
    "line" : ["Krankenhaus-Straße 1-7 Haupteingang"],
    "_line" : [{
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName",
        "valueString" : "Krankenhaus-Straße"
      },
      {
