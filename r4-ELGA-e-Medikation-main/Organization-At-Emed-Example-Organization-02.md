# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Organisation Apotheke - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Organisation Apotheke**

## Example Organization: Beispiel Organisation Apotheke
...
**address**: Apotheken-Gasse 1-7 Haupteingang St. Wolfgang Salzburg 5350 AUT (work)
...
```json
{
  ...
  "id" : "At-Emed-Example-Organization-02",
  "meta" : {
  ...
  "address" : [{
    "use" : "work",
    "type" : "both",
    "line" : ["Apotheken-Gasse 1-7 Haupteingang"],
    "_line" : [{
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName",
        "valueString" : "Apotheken-Gasse"
      },
      {
