# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Journey 03: Durchgeführte Abgabe 1 - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Journey 03: Durchgeführte Abgabe 1**

## Example MedicationDispense: Beispiel Journey 03: Durchgeführte Abgabe 1
...
```json
{
  ...
  "status" : "completed",
  "medicationReference" : {
    "reference" : "#contained-medication-journey-03-magistral-01"
  },
  "subject" : {
