...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://fhir.hl7.at/elga/emed/r4/StructureDefinition/at-elga-emed-bundle-geplanteabgabentx | *Version*:0.1.1 | |
| Draft as of 2026-09-15 | *Responsible:*[ELGA GmbH](http://elga.gv.at) | *Computable Name*:AtElgaEmedBundlegeplanteAbgabenTx |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.at.fhir.elga.emed.r4|current/StructureDefinition/StructureDefinition-at-elga-emed-bundle-geplanteabgabentx.json)
...
Other representations of profile: [CSV](StructureDefinition-at-elga-emed-bundle-geplanteabgabentx.csv), [Excel](StructureDefinition-at-elga-emed-bundle-geplanteabgabentx.xlsx), [Schematron](StructureDefinition-at-elga-emed-bundle-geplanteabgabentx.sch) 
...
```json
{
  ...
  "url" : "https://fhir.hl7.at/elga/emed/r4/StructureDefinition/at-elga-emed-bundle-geplanteabgabentx",
  "version" : "0.1.1",
