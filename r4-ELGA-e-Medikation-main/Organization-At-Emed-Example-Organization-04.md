# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Organisation Urlaubsvertretung - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Organisation Urlaubsvertretung**

## Example Organization: Beispiel Organisation Urlaubsvertretung
...
**address**: Urlaubsvertreter-Straße 8 Stiege 2 St. Wolfgang Salzburg 5350 AUT (work)
...
```json
{
  ...
  "id" : "At-Emed-Example-Organization-04",
  "meta" : {
  ...
  "address" : [{
    "use" : "work",
    "type" : "both",
    "line" : ["Urlaubsvertreter-Straße 8 Stiege 2"],
    "_line" : [{
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName",
        "valueString" : "Urlaubsvertreter-Straße"
      },
      {
