...
| | |
| :--- | :--- |
| [AT ELGA Core List](StructureDefinition-at-elga-core-list.md) | Generische Liste für ELGA-Anwendungen. Diese enthält 0..* Einträge (List.entry), wobei jedes Entry genau eine Referenz auf einen Eintrag in List.entry.item beinhaltet. Die Reihenfolge der Einträge der Liste ist relevant und kann festgelegt werden. Jeder Listeneintrag enthält im Element List.entry.flag den Änderungsstatus des jeweiligen Eintrags. |
