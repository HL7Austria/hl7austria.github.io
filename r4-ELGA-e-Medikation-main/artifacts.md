...
| [Beispiel Journey 03: Transaction Bundle](Bundle-At-Emed-Journey-03-Bundle-Geplante-Abgaben-Tx.md) | Beispiel eines Transaction Bundles, das einen Mediaktionsplan (List) mit 2 Planeinträgen (MedicationRequests) beinhaltet. |
...
| [Beispiel Journey 04: Transaction Bundle](Bundle-At-Emed-Journey-04-Bundle-Durchgefuehrte-Abgaben-Tx.md) | Beispiel eines Transaction Bundles, das einen Mediaktionsplan (List) mit 2 Planeinträgen (MedicationRequests) beinhaltet. |
