# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 1 - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 1**

## Example MedicationRequest: Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 1
...
```json
{
  ...
  "id" : "AtEmedExampleDosageStandardAdministration1",
  "meta" : {
