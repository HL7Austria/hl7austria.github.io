# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 3 - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 3**

## Example MedicationRequest: Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 3
...
```json
{
  ...
  "id" : "AtEmedExampleDosageStandardAdministration3",
  "meta" : {
  ...
  },
  {
    ...
    "valueMarkdown" : "2-0-2-0 Mon wöchentlich; 0-0-0-1 Mi wöchentlich | Wöchentlich montags 2 Stück morgens und 2 Stück abends und mittwochs 1 Stück nachts"
  }],
  "identifier" : [{
