...
1. Der GDA führt die Custom Operation**POST**[$groupidentifier-search](OperationDefinition-AtEmed.GroupIdentifier.Search.md)aus und übermittelt einen**e-Med GroupIdentifier**.
