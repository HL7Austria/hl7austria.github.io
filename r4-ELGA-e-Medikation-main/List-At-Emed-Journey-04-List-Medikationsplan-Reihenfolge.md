# HL7.AT.FHIR.ELGA.EMED.R4\Beispiel Journey 04: Reihenfolge der Planeinträge ändern - FHIR® v4.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Journey 04: Reihenfolge der Planeinträge ändern**

## Example List: Beispiel Journey 04: Reihenfolge der Planeinträge ändern

Profile: [ELGA e-Med Medikationsplan](StructureDefinition-at-emed-list-medikationsplan.md)

| | | | |
| :--- | :--- | :--- | :--- |
| Date: 2026-02-05 08:00:00+0000 | Mode: Working List | Status: Current | Code: Medikationsplan |
